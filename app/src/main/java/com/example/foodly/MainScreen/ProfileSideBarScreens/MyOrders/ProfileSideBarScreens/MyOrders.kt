...
@Composable
fun MyOrdersScreen(homeScreenStateViewModel: HomeScreenStateViewModel = viewModel()) {
                        ...
                        onClick = {
                            when (i) {
                                0 -> {
                                    ...
                                    homeScreenStateViewModel.completedButtonClicked.value = false
                                    homeScreenStateViewModel.cancelledButtonClicked.value = false
